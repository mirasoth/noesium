...
class TestCognitiveContextBasics:
    ...
    def test_add_finding_auto_trim(self) -> None:
...
class TestScratchpad:
    ...
    def test_set_and_get_scratchpad(self) -> None:
    ...
    def test_get_scratchpad_default(self) -> None:
    ...
    def test_scratchpad_overwrite(self) -> None:
...
class TestExport:
    ...
    def test_export_goal_only(self) -> None:
    ...
    def test_export_with_findings(self) -> None:
    ...
    def test_export_without_scratchpad(self) -> None:
    ...
    def test_export_with_scratchpad(self) -> None:
...
class TestForSubagent:
    ...
    def test_for_subagent_basic(self) -> None:
    ...
    def test_for_subagent_isolation(self) -> None:
...
class TestMemoryIntegration:
    ...
    async def test_save(self) -> None:
        ...
        await ctx.save(mock_memory, key="test_context")
    ...
    async def test_load_success(self) -> None:
        ...
        mock_memory.read.return_value = mock_result

        success = await ctx.load(mock_memory, key="test_context")
    ...
    async def test_load_not_found(self) -> None:
        ...
        success = await ctx.load(mock_memory)
    ...
    async def test_enrich(self) -> None:
        ...
        recalled = await ctx.enrich(mock_memory, limit=2)
    ...
    @pytest.mark.asyncio
    async def test_enrich_empty_goal(self) -> None:
        """Test enrich with no goal returns empty."""
        ctx = CognitiveContext()

        mock_memory = AsyncMock()
        recalled = await ctx.enrich(mock_memory)

        assert recalled == []
        mock_memory.recall.assert_not_called()

    @pytest.mark.asyncio
    async def test_enrich_with_custom_query(self) -> None:

...
from noesium.subagents.bu.code_use import create_namespace
...
def session_to_python_script(agent: CodeAgent) -> str:
    ...
    lines.append("from noesium.subagents.bu import BrowserSession\n")
    lines.append("from noesium.subagents.bu.code_use import create_namespace\n\n")

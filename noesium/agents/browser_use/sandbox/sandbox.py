...
from noesium.agents.browser_use.sandbox.views import (
    BrowserCreatedData,
    ErrorData,
    LogData,
    ResultData,
    ...
    **env_vars: str,
    ...
    def decorator(
        ...
        async def wrapper(*args, **kwargs) -> T:
            ...
            if needed_imports:
                needed_imports = "from noesium.agents.browser_use import Browser\n" + needed_imports
            else:
                needed_imports = "from noesium.agents.browser_use import Browser"
            ...
            # Build function call
            if explicit_params:
                function_call = f"await {func.__name__}(browser=browser, **{{k: _params[k] for k in {list(explicit_params.keys())!r}}})"
            else:

...
from ..llm_adapter import ContentImage, ContentText, SystemMessage, UserMessage
...
if TYPE_CHECKING:
    ...
    from .views import AgentStepInfo
...
class SystemPrompt:
    ...
    def _load_prompt_template(self) -> None:
        ...
        try:
            ...
            with (
                importlib.resources.files("noesium.agents.browser_use.agent")

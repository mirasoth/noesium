...
from noesium.agents.browser_use.agent.message_manager.utils import save_conversation
from noesium.agents.browser_use.tokens.service import TokenCost
...
from noesium.agents.browser_use import Browser, BrowserProfile, BrowserSession
from noesium.agents.browser_use.agent.judge import construct_judge_messages

# Lazy import for gif to avoid heavy agent.views import at startup
# from noesium.agents.browser_use.agent.gif import create_history_gif
from noesium.agents.browser_use.agent.message_manager.service import (
    MessageManager,
)
from noesium.agents.browser_use.agent.prompts import SystemPrompt
from noesium.agents.browser_use.agent.views import (
    ActionResult,
    AgentError,
    AgentHistory,
    AgentHistoryList,
...
from noesium.agents.browser_use.browser.events import _get_timeout
from noesium.agents.browser_use.browser.session import DEFAULT_BROWSER_PROFILE
...
from noesium.agents.browser_use.dom.views import DOMInteractedElement, MatchLevel
from noesium.agents.browser_use.filesystem.file_system import FileSystem
from noesium.agents.browser_use.observability import observe, observe_debug
from noesium.agents.browser_use.tools.registry.views import ActionModel
from noesium.agents.browser_use.tools.service import Tools
from noesium.agents.browser_use.utils import (
    URL_PATTERN,
    _log_pretty_path,
...
class Agent(Generic[Context, AgentStructuredOutput]):
        ...
        **kwargs,
        ...
        if llm is None:
            ...
            if default_llm_name:
                ...
                # from noesium.agents.browser_use.llm.models import get_llm_by_name
        ...
        is_anthropic = "claude" in self.llm.model.lower() or "anthropic" in self.llm.model.lower()
    ...
    def logger(self) -> logging.Logger:
        ...
        _browser_session_id = (
            browser_session.id[-4:] if (browser_session := getattr(self, "browser_session", None)) else "----"
        )
        _current_target_id = (
    ...
    def _set_screenshot_service(self) -> None:
        ...
        try:
            from noesium.agents.browser_use.screenshots.service import ScreenshotService
    ...
    def _process_messsages_and_replace_long_urls_shorter_ones(
        ...
        """
        from noesium.agents.browser_use.adapters.llm_adapter import AssistantMessage, UserMessage
    ...
    async def get_model_output(self, input_messages: list[BaseMessage]) -> AgentOutput:
        ...
        kwargs: dict = {"output_format": self.AgentOutput}  # session_id not supported in noesium adapter
    ...
    async def _broadcast_model_state(self, parsed: "AgentOutput") -> None:
        ...
        if state.evaluation_previous_goal:
            ...
            level = (
                "success" if "success" in eval_text.lower() else "warning" if "failure" in eval_text.lower() else "info"
            )
    ...
    async def run(
        ...
        from noesium.agents.browser_use.utils import SignalHandler
    ...
    async def _generate_rerun_summary(
        ...
        from noesium.agents.browser_use.agent.views import RerunSummaryAction
        ...
        from noesium.agents.browser_use.agent.prompts import get_rerun_summary_message, get_rerun_summary_prompt
        ...
        try:
            ...
            from noesium.agents.browser_use.adapters.llm_adapter import BaseMessage
    ...
    async def _execute_ai_step(
        ...
        """
        from noesium.agents.browser_use.adapters.llm_adapter import SystemMessage, UserMessage
        from noesium.agents.browser_use.agent.prompts import (
            get_ai_step_system_prompt,
            get_ai_step_user_prompt,
            get_rerun_summary_message,
        )
        from noesium.agents.browser_use.utils import sanitize_surrogates
        ...
        try:
            from noesium.agents.browser_use.dom.markdown_extractor import extract_clean_markdown
    ...
    def detect_variables(self) -> dict[str, DetectedVariable]:
        ...
        from noesium.agents.browser_use.agent.variable_detector import detect_variables_in_history

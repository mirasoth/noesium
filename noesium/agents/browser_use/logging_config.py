    ...
    class BrowserUseFormatter(logging.Formatter):
        ...
        def format(self, record):
            ...
            if (
                ...
                and record.name.startswith("noesium.agents.browser_use.")
            ):
                ...
                if "Agent" in record.name:
                    ...
                    record.name = "dom"
                elif record.name.startswith("noesium.agents.browser_use."):
...
def setup_log_pipes(session_id: str, base_dir: str | None = None):
    ...
    for name in ["noesium.agents.browser_use.agent", "noesium.agents.browser_use.tools"]:
    ...
    for name in ["bubus", "noesium.agents.browser_use.browser.session"]:
        logger = logging.getLogger(name)

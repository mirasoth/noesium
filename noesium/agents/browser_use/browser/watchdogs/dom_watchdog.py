...
from noesium.agents.browser_use.dom.views import (
    EnhancedDOMTreeNode,
    SerializedDOMState,
)
from noesium.agents.browser_use.observability import observe_debug
from noesium.agents.browser_use.utils import create_task_with_error_handling, time_execution_async

if TYPE_CHECKING:
    from noesium.agents.browser_use.browser.views import BrowserStateSummary, NetworkRequest, PageInfo, PaginationButton
...
class DOMWatchdog(BaseWatchdog):
    ...
    async def _get_pending_network_requests(self) -> list["NetworkRequest"]:
        ...
        """
        from noesium.agents.browser_use.browser.views import NetworkRequest
...
"""
    ...
    async def on_BrowserStateRequestEvent(self, event: BrowserStateRequestEvent) -> "BrowserStateSummary":
        ...
        """
        from noesium.agents.browser_use.browser.views import BrowserStateSummary, PageInfo
    ...
    def _detect_pagination_buttons(self, selector_map: dict[int, EnhancedDOMTreeNode]) -> list["PaginationButton"]:
        ...
        """
        from noesium.agents.browser_use.browser.views import PaginationButton
    ...
    async def _get_page_info(self) -> "PageInfo":
        ...
        from noesium.agents.browser_use.browser.views import PageInfo

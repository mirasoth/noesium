...
from noesium.agents.browser_use.browser.events import AgentFocusChangedEvent, BrowserConnectedEvent, BrowserStopEvent
from noesium.agents.browser_use.browser.profile import ViewportSize
from noesium.agents.browser_use.browser.video_recorder import VideoRecorderService
...
class RecordingWatchdog(BaseWatchdog):
    ...
    async def on_BrowserConnectedEvent(self, event: BrowserConnectedEvent) -> None:
        ...
        self._recorder = VideoRecorderService(
            output_path=output_path, size=size, framerate=profile.record_video_framerate
        )

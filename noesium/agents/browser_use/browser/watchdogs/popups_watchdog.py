...
from ..events import DialogOpenedEvent, TabCreatedEvent
...
class PopupsWatchdog(BaseWatchdog):
    ...
    async def on_TabCreatedEvent(self, event: TabCreatedEvent) -> None:
        ...
        try:
            ...
            async def handle_dialog(event_data, session_id: str | None = None):
                ...
                self.logger.debug(
                    f"🔔 JavaScript {dialog_type} dialog detected: '{message[:50]}...' - accepting immediately"
                )
    ...
    async def on_DialogOpenedEvent(self, event: DialogOpenedEvent) -> None:
        ...
        self.browser_session.agent_focus.url

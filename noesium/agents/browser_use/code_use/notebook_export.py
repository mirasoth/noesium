...
from noesium.agents.browser_use.code_use import create_namespace
...
def session_to_python_script(agent: CodeAgent) -> str:
    ...
    lines.append("from noesium.agents.browser_use import BrowserSession\n")
    lines.append("from noesium.agents.browser_use.code_use import create_namespace\n\n")

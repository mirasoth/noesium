...
from noesium.agents.browser_use.browser.profile import BrowserProfile
...
from noesium.agents.browser_use.tools.service import CodeAgentTools, Tools
from noesium.agents.browser_use.utils import get_browser_use_version
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if controller and tools:
            raise ValueError(
                'Cannot specify both "controller" and "tools" parameters. Use "controller" for the cleaner API.'
            )

...
from noesium.agents.browser_use.adapters.llm_adapter import AssistantMessage, SystemMessage, UserMessage
...
# This test needs to be adapted for noesium's LLM client

...
**Depends on**: [RFC-0006](RFC-0006.md)
**Supersedes**: ---
**Stage**: Core
...
RFC-0006 establishes the architectural requirement for sandboxed effect executor execution. This RFC provides the implementation architecture using OpenSandbox as the container-based execution runtime.
...
- **RFC-0006**: Implements the sandboxed effect executor architecture specified in RFC-0006

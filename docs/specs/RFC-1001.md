...
**Implementation Status**: This RFC describes the conceptual design for event-sourced architecture. The EventEnvelope and EventStore components have been simplified out of the core implementation in favor of a more pragmatic approach using ProgressEvent for TUI streaming and CognitiveContext (RFC-1010) for agent state continuity. See Section 19 for details.

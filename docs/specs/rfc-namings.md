...
| Goal Queue | RFC-1006 §8 | Priority queue of active goals maintained by Goal Engine with highest_priority_first scheduling |
...
| Semantic Memory | RFC-1002 §5.3 | Indexed retrieval layer derived from durable memory via embeddings |

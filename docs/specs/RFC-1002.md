# RFC-1002: Projection and Memory Formal Model

**Status**: Draft
**Authors**: Noesium Team
**Created**: 2025-03-01
**Last Updated**: 2026-03-07
**Depends on**: [RFC-0001](RFC-0001.md), [RFC-1001](RFC-1001.md)
**Supersedes**: ---
...
> **Implementation Note**: For practical agent development, [CognitiveContext (RFC-1010)](RFC-1010.md) provides a lightweight alternative to full cognitive projections. CognitiveContext maintains a 3-field model (goal, findings, scratchpad) without requiring event-sourced infrastructure, making it suitable for TUI conversations and subagent context passing.
...
* Exists during a single agent execution session
...
RFC-1002 formalizes Noesium’s memory architecture as:

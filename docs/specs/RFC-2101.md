# RFC-2101: OpenSandbox-Based Multi-User Agent Isolation Architecture

**Status**: Draft
**Authors**: chenxm
**Created**: 2026-03-01
**Last Updated**: 2026-03-07
**Depends on**: [RFC-1004](RFC-1004.md)
**Supersedes**: ---
**Stage**: Core
...
This RFC specifies the concrete implementation architecture for multi-user agent isolation using OpenSandbox as the execution runtime for effect executor (tool) execution.
...
[RFC-1004](RFC-1004.md) establishes the architectural requirement for sandboxed effect executor execution. This RFC provides the implementation architecture using OpenSandbox as the container-based execution runtime.
...
- Effect executor dispatch to executor
...
2. Capability registry validates permissions per [RFC-1003](RFC-1003.md)
...
- **[RFC-1004](RFC-1004.md)**: Implements the sandboxed effect executor architecture specified in RFC-1004
- **[RFC-1003](RFC-1003.md)**: Uses capability registry for permission validation
- **[RFC-1004](RFC-1004.md)**: Enforces deterministic kernel by isolating all non-deterministic operations

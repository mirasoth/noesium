...
from noesium.core.routing.strategies.dynamic_complexity import DynamicComplexityStrategy
from noesium.core.routing.types import ModelTier, RoutingResult
...
class TestDynamicComplexityStrategy:
    ...
    @patch("noesium.core.utils.logging.get_logger")
